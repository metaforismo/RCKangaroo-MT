...
std::string RCKJacobianKangarooSmallBenchJson(unsigned int iterations, unsigned int min_ms = 0, unsigned int range_bits = 8, unsigned int jump_count = 8, unsigned int dp_bits = 0, unsigned int max_steps = 4096, const char* jump_schedule = "power2", unsigned int key_offset = 0xFFFFFFFFU);
std::string RCKJacobianKangarooMultiSmallBenchJson(unsigned int iterations, unsigned int min_ms = 0, unsigned int target_count = 4, unsigned int range_bits = 8, unsigned int jump_count = 8, unsigned int dp_bits = 0, unsigned int max_steps = 4096, const char* jump_schedule = "power2", unsigned int key_offset = 0xFFFFFFFFU);
