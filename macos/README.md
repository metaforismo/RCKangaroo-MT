...
This builds `macos/rck_macos`, runs host secp256k1 vector checks, validates target parsing, runs the native CPU selftest, checks CPU field arithmetic, and runs the Metal field-add/sub/double/neg/mul/square checks when Metal is visible.
...
Run the Metal secp256k1 field-add, field-sub, field-double, field-neg, field-mul, and field-square checks and benchmarks:
