...
std::string RCKMetalJacobianDynamicDpStreamXyzzAffineScanTargetLookupTag32BenchJson(unsigned int iterations, unsigned int steps_per_sample, unsigned int jump_count, unsigned int min_ms, unsigned int target_count, unsigned int requested_hits, unsigned int lookup_repeat = 1, unsigned int threadgroup_limit = 0, unsigned int dp_bits = 0, const char* jump_schedule = "power2", const char* lookup_query_mode = "repeat", const char* lookup_engine = "gpu", unsigned int lookup_threadgroup_limit = 0, const char* lookup_filter_mode = "tag16");
std::string RCKMetalJacobianDynamicDpStreamXyzzAffineScanTargetLookupTag32RoundsBenchJson(unsigned int iterations, unsigned int steps_per_sample, unsigned int jump_count, unsigned int round_count, unsigned int target_count, unsigned int requested_hits_per_round, unsigned int lookup_repeat = 1, unsigned int threadgroup_limit = 0, unsigned int dp_bits = 0, const char* jump_schedule = "power2", unsigned int lookup_threadgroup_limit = 0, unsigned int lookup_filter_bits = 16, bool lookup_filter_mix = false, bool lookup_repeat_dedup = false, const char* lookup_query_mode = "repeat", bool lookup_filter_bloom64 = false, const char* walk_round_mode = "independent");
...
std::string RCKMetalTargetLookupTag16HashFilterPersistentBenchJson(unsigned int target_count, unsigned int query_count, unsigned int expected_hits, unsigned int min_ms = 0, unsigned int threadgroup_limit = 0);
