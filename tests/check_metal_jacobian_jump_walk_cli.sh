...
case "$output" in
	*"\"backend\":\"metal\""*"\"operation\":\"jacobian_affine_walk_jump_table\""*"\"sample_count\":8"*"\"steps_per_sample\":4"*"\"jump_count\":5"*"\"distance_tracking\":\"uint64\""*"\"dp_tracking\":\"projective_x_limb0\""*"\"dp_bits\":4"*"\"dp_count\":"*"\"dp_checksum\":\"0x"*"\"correctness\":true"*)
		;;
	*"\"backend\":\"metal\""*"\"operation\":\"jacobian_affine_walk_jump_table\""*"\"sample_count\":8"*"\"steps_per_sample\":4"*"\"jump_count\":5"*"\"distance_tracking\":\"uint64\""*"\"dp_tracking\":\"projective_x_limb0\""*"\"dp_bits\":4"*"\"skipped\":true"*"\"reason\":\"no Metal device available\""*)
		;;
	*)
