...
case "$output" in
	*"\"backend\":\"macos_cpu\""*"\"operation\":\"jacobian_batch_affine\""*"\"affine_conversion\":\"batch\""*"\"batch_points\":17"*"\"wild_points\":16"*"\"iterations\":"*"\"ops_per_sec\":"*"\"points_per_sec\":"*"\"checksum\":\"0x"*"\"correctness\":true"*)
		exit 0
		;;
	*)
		printf '%s\n' "$output"
