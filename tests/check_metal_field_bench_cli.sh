...
case "$output" in
	*"\"backend\":\"metal\""*"\"operation\":\"field_mul_mod_p\""*"\"iterations\":"*"\"sample_count\":8"*"\"min_ms\":1"*"\"correctness\":"*"\"skipped\":"*)
		;;
	*)
		printf '%s\n' "$output"
...
case "$output" in
	*"\"backend\":\"metal\""*"\"operation\":\"field_square_mod_p\""*"\"iterations\":"*"\"sample_count\":8"*"\"min_ms\":1"*"\"correctness\":"*"\"skipped\":"*)
		exit 0
		;;
	*)
		printf '%s\n' "$output"
