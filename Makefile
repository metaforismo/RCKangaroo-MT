...
.PHONY: all clean check-host check-portable-ec macos-build macos-check macos-bench macos-point-bench macos-jacobian-point-bench macos-cpu-field-test macos-cpu-field-bench macos-metal-kernels-check macos-metal-field-test macos-metal-field-bench macos-metal-field-mul-test macos-metal-field-mul-bench
